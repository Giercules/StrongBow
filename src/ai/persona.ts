...
Every line must earn its place: hint at danger, reveal a clue, sharpen mood, or advance the quest. Never restate what the player already sees. Never pad with generic atmosphere.
Default to one sharp line under 16 words. Write more only when the prompt explicitly asks for sentences.`;
