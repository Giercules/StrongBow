...
export const THEMES: Record<ThemeId, ThemeDef> = {
  crypt: {
    ...
    decorKeys: ['bones', 'rubble', 'gravestone', 'candle', 'bone-pile', 'banner'],
  ...
  molten: {
    ...
    primaryHazard: 'lava',
    traps: false,
    roomShapes: ['rect', 'cavern', 'hall'],
    decorKeys: ['rubble', 'bones', 'lava-crack', 'obsidian', 'brazier'],
  ...
  frost: {
    ...
    decorKeys: ['crystal', 'sky-crystal', 'pillar', 'icicle', 'frost-banner', 'candle'],
    enemies: ['frost_shade', 'rime_archer', 'frost_shade', 'ghost', 'rime_archer', 'frost_shade'],
    boss: 'rime_cantor',
    setPieces: ['frozenAltar', 'crystalCluster', 'treasureVault', 'guardianHall'],
    layout: 'cathedral',
  ...
  toxic: {
    ...
    decorKeys: ['vines', 'bones', 'rubble', 'toxic-mushroom', 'cattail'],
  ...
  clockwork: {
    ...
    traps: true,
    roomShapes: ['rect', 'cross', 'hall'],
    decorKeys: ['cog', 'pillar', 'banner', 'pipe', 'gauge', 'brazier'],
  ...
  arena: {
    ...
    primaryHazard: 'lava',
    traps: true,
    roomShapes: ['circle', 'rect', 'circle', 'hall'],
    decorKeys: ['blood-stain', 'skull-pike', 'banner', 'brazier', 'weapon-rack', 'bones'],
    enemies: ['gladiator', 'brute', 'gladiator', 'demon', 'imp', 'gladiator'],
    boss: 'arena_champion',
    setPieces: ['arenaRing', 'spikeGauntlet', 'treasureVault'],
    layout: 'arena',
  ...
  bog: {
    ...
    decorKeys: ['bog-stump', 'lilypad', 'vines', 'dead-tree', 'cattail', 'bones'],
  ...
  storm: {
    ...
    decorKeys: ['storm-rod', 'sky-crystal', 'pillar', 'storm-orb', 'banner'],
    enemies: ['storm_wisp', 'sky_lancer', 'storm_wisp', 'sky_lancer', 'imp', 'storm_wisp'],
    boss: 'tempest_herald',
    setPieces: ['crystalCluster', 'guardianHall', 'spikeGauntlet', 'treasureVault'],
    layout: 'spire',
  ...
  shadow: {
    ...
    decorKeys: ['void-rift', 'skull-pike', 'bone-pile', 'rune-circle', 'candle'],
    enemies: ['shadow_stalker', 'void_imp', 'shadow_stalker', 'ghost', 'void_imp', 'shadow_stalker'],
    boss: 'umbral_devourer',
    setPieces: ['guardianHall', 'treasureVault', 'spikeGauntlet', 'crystalCluster'],
    layout: 'warren',
  ...
  sanctum: {
    ...
    decorKeys: ['sanctum-glyph', 'brazier', 'pillar', 'idol', 'altar', 'banner'],
