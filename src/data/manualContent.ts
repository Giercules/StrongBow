...
export const MANUAL_PAGES: ManualPage[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'WIN: slay the realm’s warden, then stand on the exit portal to descend. Cleared gates show a green check back in town.',
      'THE ALTAR BARGAIN: no spawning altar is required. Every one left standing FEEDS the warden — with all of them intact he hits roughly twice as hard and carries nearly three times the health, a fight that will test a full party running pets. Each altar you shatter takes a slice of that back, and the HUD shows exactly how charged he still is (WARDEN EMPOWERED %). Rush him for glory, or dismantle his supply first. DIFFICULTY sets how hard the altars drive him: easy 0.6x, moderate 1x, hard 1.3x.',
  ...
  },
  {
    ...
    body: [
      ...
      'FELLOWSHIP: a kill is banked by your whole living company at once — it does not matter who landed the blow — and the share GROWS with the company. Alone you bank 82% of a kill; with two hires 100%; with a full roster 125%. Bigger parties also face tougher monsters, so the extra is earned. Walking in alone is the slow, deliberate road; hiring is how you pick up the pace. (Fallen allies stop counting, so raise them.) Tune companion behaviour in Settings -> Allies.',
    ],
  },
  {
    title: 'Growth & Gear',
    ...
    body: [
      ...
      'THE CLIMB IS LONG. Level 20 is not something one pass through the world hands you: a thorough sweep of all ten realms leaves a lone hero around 13, a full company around 16. The rest is earned by going back down — the altars never stop pumping, and a realm you have already cleared is still worth farming.',
