...
export const MANUAL_PAGES: ManualPage[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Press SPACE to dodge-roll (brief invulnerability), and F for your class ability: Vanguard Seismic Slam, Arcanist Meteor, Warden SANCTUARY — a burst heal that also RESURRECTS a fallen ally nearby; the Warden additionally radiates a passive REGEN aura that mends nearby allies and necromancer pets over time, and both grow stronger and farther-reaching as the Warden levels. The Thief toggles SNEAK (melt into shadow — every foe rolls on its own to notice you, and higher Sneak keeps you unseen; a strike from stealth or at a turned-away foe is a BACKSTAB for 2.4x, now on a short cooldown that shrinks as Sneak grows). From stealth, press T to PICKPOCKET the nearest foe or townsfolk — Sneak and Pickpocket level set both your odds and the haul (up to a Godforged item at mastery); a failed lift simply comes up empty. The Necromancer HOLDS the ability for a radial — aim with mouse or stick to pick a Tank, Archer, Mage or Thief skeleton (a quick tap raises the last-chosen). Each servant shows a shrinking lifetime bar and blinks in its final seconds before crumbling to dust, and the mightier the Necromancer grows, the tougher and deadlier the undead he raises.',
    ],
  },
  {
